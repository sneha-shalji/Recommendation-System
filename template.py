...
project_name = "book_recommeder"


list_of_files = [
    f"{project_name}/__innit__.py",
    ...
    f"{project_name}/config/__innit__.py",
    f"{project_name}/config/sconfiguration.py",
    f"{project_name}/constant/__innit__.py",
    f"{project_name}/entity/__innit__.py",
    f"{project_name}/entity/config_entity.py",
    f"{project_name}/exception/__innit__.py",
    f"{project_name}/exception/exception_handler.py",
    f"{project_name}/logger/__innit__py",
    f"{project_name}/logger/log.py",
    f"{project_name}/pipeline/__innit__.py",
